...
output: 
  flexdashboard::flex_dashboard:
    ...
    theme: lumen
    navbar:
      - { icon: "fa-github", href: "https://github.com/", align: right}
runtime: shiny
---
...
master_hike <- dplyr::bind_rows(gorgas, houston_meadows_loop) %>%
...
`r hr()`
`r hr()`
*More Wissahickon Valley Info: [Friends of the Wissahickon](https://www.fow.org/)*  

*Project Inspiration: [FOW Map](https://www.google.com/maps/d/viewer?mid=13bnd0IRNwzTpI7VFPASNSWXC5yk&ll=40.046209997931044%2C-75.20679951607832&z=14)*  
